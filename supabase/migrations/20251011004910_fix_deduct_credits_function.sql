-- Fix deduct_credits function to handle missing user_credits records
-- This ensures the function works for new users automatically
...
COMMENT ON FUNCTION deduct_credits IS 'Atomically deduct credits with idempotency and auto-creation of user credits';