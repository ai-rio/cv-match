...
async def stripe_webhook(
    ...
    try:
        ...
        processing_result.update({
            "webhook_id": event_id,
            "client_ip": client_ip,
            "processed_at": stripe_service.webhook_secret is not None  # Verify webhook is configured
        })
        ...
        if processing_result["success"]:
            ...
            logger.error(f"Webhook event {event_type} processing failed: {processing_result['error']}")
