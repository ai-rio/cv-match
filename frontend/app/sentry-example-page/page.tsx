    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://advanced-ee.sentry.io/issues/?project=4510150794412032">Issues Page</a>.
