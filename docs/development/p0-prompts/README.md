...
**Start after Phase 1 completes**: 3. **Agent**: database-architect
...
**Start after Phase 2 completes**: 4. **Agent**: backend-specialist
...
**Start after Phase 3 completes**: 5. **Agent**: test-writer-agent
