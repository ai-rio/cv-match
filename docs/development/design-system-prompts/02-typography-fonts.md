...
```tsx
import { H1, H2, H3, H4, P, Lead, Small, Muted, Code, Blockquote } from '@/components/ui/typography'
...
export default function TypographyPage() {
  return (
    <div className="container max-w-4xl py-12 space-y-12">
      ...
      <section className="space-y-4">
        ...
        <Lead>
          Testing the complete typography scale with Plus Jakarta Sans, Source Serif 4, and JetBrains Mono.
        </Lead>
      </section>
      ...
      <section className="space-y-4">
        <H2>Body Text</H2>
        <P>
          This is regular paragraph text using Plus Jakarta Sans. It should be highly readable at 16px (1rem) with a 
          line height of 1.5. The font is optimized for body copy and UI elements.
        </P>
        <Lead>
          This is lead text - slightly larger and used for introductions or emphasis. Great for setting context 
          before diving into details.
        </Lead>
        <Muted>
          This is muted text - used for secondary information that's less important but still relevant.
        </Muted>
        <Small>
  ...
  return <MatchGauge score={score} />
      ...
      <section className="space-y-4">
        <H2>Quotes</H2>
        <Blockquote>
          "Depois de otimizar, consegui 3 entrevistas em uma semana!"
          — Maria S., Desenvolvedora Senior
        </Blockquote>
      </section>
...
<Card>
  ...
  <CardContent>
    <P>
      Algoritmos que analisam e melhoram seu currículo automaticamente.
    </P>
  </CardContent>
</Card>
```
