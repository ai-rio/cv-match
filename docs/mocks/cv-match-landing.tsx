...
import { Upload, CheckCircle2, Zap, Shield, ArrowRight, TrendingUp, FileCheck, Brain, Award, ChevronDown, Lock, Sparkles, BarChart3, Clock, Target, Users, Star } from 'lucide-react';
...
const CVMatchLanding = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ backgroundColor: 'var(--background)', fontFamily: 'system-ui, sans-serif' }}>
        {/* Navigation */}
        <nav style={{
          position: 'fixed',
          top: 0,
          ...
          zIndex: 50,
          transition: 'all 0.3s',
          backgroundColor: isScrolled ? 'color-mix(in oklch, var(--background) 95%, transparent)' : 'transparent',
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '64px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <div style={{
                  ...
                  <FileCheck style={{ width: '20px', height: '20px', color: 'var(--primary-foreground)' }} />
                </div>
                <span style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'var(--foreground)' }}>CV-Match</span>
              </div>
              <div style={{ display: 'none', gap: '1.5rem', alignItems: 'center' }} className="md-flex">
                <a href="#como-funciona" style={{ fontSize: '0.875rem', fontWeight: '500', color: 'var(--muted-foreground)', textDecoration: 'none' }}>
                  Como Funciona
                </a>
                <a href="#precos" style={{ fontSize: '0.875rem', fontWeight: '500', color: 'var(--muted-foreground)', textDecoration: 'none' }}>
                  Preços
                </a>
                <a href="#faq" style={{ fontSize: '0.875rem', fontWeight: '500', color: 'var(--muted-foreground)', textDecoration: 'none' }}>
                  FAQ
                </a>
                <button style={{ fontSize: '0.875rem', fontWeight: '500', color: 'var(--muted-foreground)', background: 'none', border: 'none', cursor: 'pointer' }}>
                  Entrar
                </button>
                <button style={{
                  height: '40px',
          ...
          <div style={{ position: 'relative', maxWidth: '1280px', margin: '0 auto' }}>
            <div style={{ maxWidth: '896px', margin: '0 auto', textAlign: 'center' }}>
              ...
              <h1 style={{
                ...
                IA que transforma{' '}
                <span style={{ color: 'var(--primary)' }}>currículos</span>
                {' '}em{' '}
              ...
              <p style={{
                ...
                Passe pelo ATS das melhores empresas brasileiras com análise inteligente de palavras-chave e otimização automática
              </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center', marginBottom: '2rem' }}>
                <button style={{
                  ...
                  justifyContent: 'center',
                  gap: '0.5rem',
                  boxShadow: '0 10px 15px -3px color-mix(in oklch, var(--primary) 25%, transparent)'
                }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1.5rem 0' }}>
                      <div style={{ position: 'relative', width: '144px', height: '144px', marginBottom: '1rem' }}>
                        ...
                        <div style={{
                          ...
                          <span style={{ fontSize: '3rem', fontWeight: 'bold', color: 'var(--foreground)' }}>92</span>
                          <span style={{ fontSize: '0.75rem', color: 'var(--muted-foreground)' }}>de 100</span>
                        </div>
                      </div>
                      <div style={{ textAlign: 'center' }}>
                        <div style={{ fontSize: '1rem', fontWeight: '600', color: 'var(--foreground)' }}>Excelente Match</div>
                        <div style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>Alta chance de aprovação</div>
                      </div>
                    </div>

                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      {[
                        { icon: CheckCircle2, label: 'Formatação ATS', value: '100%', color: 'primary' },
                        { icon: CheckCircle2, label: 'Palavras-chave', value: '+18', color: 'primary' },
                        { icon: Brain, label: 'Melhorias IA', value: '12', color: 'secondary' }
                      ].map((item, idx) => {
                        ...
                        return (
                          <div key={idx} style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                              <Icon style={{ width: '16px', height: '16px', color: `var(--${item.color})`, flexShrink: 0 }} />
                              <span style={{ fontSize: '0.875rem', fontWeight: '500', color: 'var(--foreground)' }}>
                                {item.label}
                              </span>
                            </div>
                            <span style={{ fontSize: '0.75rem', fontWeight: 'bold', color: `var(--${item.color})` }}>
                              {item.value}
                            </span>
                          </div>
                        );
            ...
            <div style={{
              ...
              {[
                ...
                <div key={idx} style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '0.5rem', color: 'var(--foreground)' }}>
                    {stat.value}
                  </div>
        ...
        <section style={{
          ...
          <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
            <div style={{ maxWidth: '768px', margin: '0 auto 4rem', textAlign: 'center' }}>
              <h2 style={{ fontSize: 'clamp(1.875rem, 4vw, 2.25rem)', fontWeight: 'bold', marginBottom: '1rem', color: 'var(--foreground)' }}>
                ...
                return (
                  <div key={idx} style={{
                    ...
                    <div style={{
                      ...
                      <Icon style={{ width: '24px', height: '24px', color: `var(--${problem.color})` }} />
                    </div>
                    <h3 style={{ fontSize: '1.125rem', fontWeight: '600', marginBottom: '0.75rem', color: 'var(--foreground)' }}>
                      {problem.title}
                    </h3>
                  ...
                  <div key={idx} style={{ position: 'relative' }}>
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <Icon style={{ width: '28px', height: '28px', color: `var(--${step.color}-foreground)` }} />
                      </div>
                      <div style={{
                        position: 'absolute',
                        top: '-12px',
                      ...
                      <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.75rem', color: 'var(--foreground)' }}>
                        {step.title}
                      </h3>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '2rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.25rem', marginBottom: '0.25rem' }}>
                    <span style={{ fontSize: '2.5rem', fontWeight: 'bold', color: 'var(--foreground)' }}>R$ 0</span>
                  </div>
                  <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>Para experimentar</p>
                </div>

                <div style={{ marginBottom: '2rem' }}>
                  {['3 análises gratuitas', 'Otimização básica ATS', 'Download em PDF', 'Sem cartão de crédito'].map((feature, idx) => (
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '2rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.25rem', marginBottom: '0.25rem' }}>
                    <span style={{ fontSize: '2.5rem', fontWeight: 'bold', color: 'var(--foreground)' }}>R$ 59,90</span>
                  </div>
                  <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>25 créditos • R$ 2,40/análise</p>
                </div>

                <div style={{ marginBottom: '2rem' }}>
                  {['25 análises completas', 'Créditos nunca expiram', 'Download DOCX e PDF', 'Suporte por email', 'Sistema de indicações'].map((feature, idx) => (
                    <div key={idx} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem' }}>
                      <CheckCircle2 style={{ width: '20px', height: '20px', color: 'var(--primary)', flexShrink: 0, marginTop: '2px' }} />
                      <span style={{ fontSize: '0.875rem', color: 'var(--foreground)' }}>{feature}</span>
                    </div>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '2rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.25rem', marginBottom: '0.25rem' }}>
                    <span style={{ fontSize: '2.5rem', fontWeight: 'bold', color: 'var(--foreground)' }}>R$ 49,90</span>
                    <span style={{ color: 'var(--muted-foreground)' }}>/mês</span>
                  </div>
                  <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>60 análises mensais</p>
                </div>

                <div style={{ marginBottom: '2rem' }}>
                  {['60 análises por mês', 'Rollover até 30 análises', 'Templates de currículo', 'Insights de carreira', 'Suporte prioritário', '20% off em créditos extras'].map((feature, idx) => (
                    <div key={idx} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', marginBottom: '0.75rem' }}>
                      <CheckCircle2 style={{ width: '20px', height: '20px', color: 'var(--primary)', flexShrink: 0, marginTop: '2px' }} />
                      <span style={{ fontSize: '0.875rem', color: 'var(--foreground)' }}>{feature}</span>
                    </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {[
                ...
                <div key={index} style={{
                  ...
                  >
                    <span style={{ fontWeight: '500', paddingRight: '1rem', color: 'var(--foreground)' }}>{faq.q}</span>
                    <ChevronDown style={{
                      width: '20px',
                      height: '20px',
                      color: 'var(--muted-foreground)',
                  ...
                  {openFaq === index && (
                    <div style={{ padding: '0 1.5rem 1rem' }}>
                      <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: '1.5' }}>{faq.a}</p>
                    </div>
                  )}
                </div>
              ))}
        ...
        <section style={{ padding: '5rem 1.5rem' }}>
          <div style={{ maxWidth: '896px', margin: '0 auto' }}>
            <div style={{
              ...
              borderRadius: '24px',
              border: '1px solid var(--border)',
              background: 'linear-gradient(135deg, color-mix(in oklch, var(--primary) 5%, transparent), color-mix(in oklch, var(--secondary) 5%, transparent), color-mix(in oklch, var(--accent) 5%, transparent))',
              padding: '3rem',
              textAlign: 'center',
              overflow: 'hidden'
            }}>
              <div style={{ position: 'relative' }}>
                <h2 style={{ fontSize: 'clamp(1.875rem, 4vw, 2.25rem)', fontWeight: 'bold', marginBottom: '1.5rem', color: 'var(--foreground)' }}>
                  Pronto para conquistar sua próxima oportunidade?
                </h2>
                <p style={{ fontSize: '1.125rem', color: 'var(--muted-foreground)', maxWidth: '672px', margin: '0 auto 2rem' }}>
                  Junte-se a milhares de profissionais brasileiros que já transformaram suas carreiras
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
                  <button style={{
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    boxShadow: '0 10px 15px -3px color-mix(in oklch, var(--primary) 20%, transparent)'
                  }}>
                    Começar Gratuitamente
                  </button>
                  <button style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                  ...
                  <span style={{ fontSize: '1.125rem', fontWeight: 'bold', color: 'var(--foreground)' }}>CV-Match</span>
                </div>
                <p style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: '1.5' }}>
              ...
              {[
                ...
                <div key={idx}>
                  <h4 style={{ fontWeight: '600', marginBottom: '1rem', fontSize: '0.875rem', color: 'var(--foreground)' }}>
                    {column.title}
                  </h4>
                  <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                    {column.links.map((link, linkIdx) => (
                      <li key={linkIdx}>
                        <a href="#" style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', textDecoration: 'none' }}>
                          {link}
                        </a>
                      </li>
                    ))}
