          ...
          >
            ...
            <div
              style={{
                padding: "2rem",
                backgroundColor:
                  "linear-gradient(135deg, color-mix(in oklch, var(--primary) 5%, transparent), color-mix(in oklch, var(--secondary) 5%, transparent))",
                borderRadius: "16px",
                border: "1px solid var(--border)",
                marginBottom: "2rem",
                textAlign: "center",
            ...
            >
              ...
              >
                Indique amigos e ganhe 5 créditos para cada indicação que fizer
                uma análise
              </p>
              <button
                style={{
