...
import { Upload, FileText, ArrowRight, ArrowLeft, Sparkles, Brain, CheckCircle2, AlertCircle, Download, Copy, ChevronRight, Target, Zap, TrendingUp, X } from 'lucide-react';
...
const CVMatchAnalysisFlow = () => {
  ...
  const mockResults = {
    ...
    keywords: {
      ...
      missing: ['React', 'TypeScript', 'Node.js', 'Docker', 'CI/CD', 'AWS', 'Microservices', 'GraphQL']
    },
    atsCompatibility: {
      formatting: 100,
      keywords: 75,
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          {step === 1 && (
            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
              <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                <h1 style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)', fontWeight: 'bold', color: 'var(--foreground)', marginBottom: '0.5rem' }}>
                  Envie seu currículo
                </h1>
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: '16px',
                  backgroundColor: dragActive ? 'color-mix(in oklch, var(--primary) 5%, transparent)' : 'var(--card)',
                  textAlign: 'center',
                  cursor: 'pointer',
                  transition: 'all 0.3s'
                }}
                ...
                {!resumeFile ? (
                  <>
                    <Upload style={{
                      width: '64px',
                      height: '64px',
                      color: dragActive ? 'var(--primary)' : 'var(--muted-foreground)',
                      margin: '0 auto 1.5rem',
                      transition: 'all 0.3s'
                    }} />
                    <h3 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'var(--foreground)', marginBottom: '0.5rem' }}>
                      {dragActive ? 'Solte o arquivo aqui' : 'Arraste seu currículo aqui'}
                    </h3>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <div style={{
                        ...
                        <FileText style={{ width: '24px', height: '24px', color: 'var(--primary-foreground)' }} />
                      </div>
                    ...
                    >
                      <X style={{ width: '20px', height: '20px', color: 'var(--muted-foreground)' }} />
                    </button>
                  </div>
                )}
              </div>
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <AlertCircle style={{ width: '20px', height: '20px', color: 'var(--accent-foreground)', flexShrink: 0 }} />
                  <div style={{ fontSize: '0.75rem', color: 'var(--muted-foreground)', lineHeight: '1.5' }}>
                    <strong style={{ color: 'var(--foreground)' }}>Dica:</strong> Inclua toda a descrição da vaga para resultados mais precisos. Nossa IA identificará as palavras-chave mais importantes automaticamente.
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  height: '48px',
                  marginTop: '1.5rem',
                  backgroundColor: !jobDescription || jobDescription.length < 50 ? 'var(--muted)' : 'var(--primary)',
                  color: 'var(--primary-foreground)',
                  border: 'none',
                  borderRadius: '8px',
                  fontWeight: '600',
                  cursor: !jobDescription || jobDescription.length < 50 ? 'not-allowed' : 'pointer',
                  fontSize: '1rem',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '0.5rem',
                  opacity: !jobDescription || jobDescription.length < 50 ? 0.5 : 1
                }}
              >
          ...
          {step === 3 && (
            <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', padding: '4rem 0' }}>
              ...
              <p style={{ fontSize: '1rem', color: 'var(--muted-foreground)', marginBottom: '2rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left', maxWidth: '400px', margin: '0 auto' }}>
                {[
                  ...
                  <div key={idx} style={{
                    ...
                    <span style={{ fontSize: '0.875rem', color: 'var(--foreground)' }}>{item.text}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {step === 4 && (
            <div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ fontSize: '2.5rem', fontWeight: 'bold', color: 'var(--foreground)' }}>
                      {mockResults.score}
                    </span>
                    <span style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)' }}>de 100</span>
                  </div>
                </div>
                ...
                <p style={{ fontSize: '1rem', color: 'var(--muted-foreground)', marginBottom: '1.5rem' }}>
              ...
              <div style={{
                ...
                <h2 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'var(--foreground)', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Target style={{ width: '24px', height: '24px', color: 'var(--primary)' }} />
                  Compatibilidade ATS
                </h2>
                
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  {Object.entries(mockResults.atsCompatibility).map(([key, value]) => (
                    <div key={key}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                        <span style={{ fontSize: '0.875rem', fontWeight: '500', color: 'var(--foreground)', textTransform: 'capitalize' }}>
                          {key === 'formatting' ? 'Formatação' : key === 'keywords' ? 'Palavras-chave' : 'Estrutura'}
                        </span>
                        <span style={{ fontSize: '0.875rem', fontWeight: 'bold', color: getScoreColor(value) }}>
                          {value}%
                        </span>
                      </div>
                      <div style={{
              ...
              <div style={{
                ...
                <h2 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'var(--foreground)', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Zap style={{ width: '24px', height: '24px', color: 'var(--secondary)' }} />
                  Análise de Palavras-chave
                </h2>
                
                <div style={{ display: 'grid', gap: '1.5rem', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))' }}>
                  <div>
                    <div style={{ fontSize: '0.875rem', fontWeight: '600', color: 'var(--foreground)', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div style={{
                ...
                <h2 style={{ fontSize: '1.25rem', fontWeight: 'bold', color: 'var(--foreground)', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <TrendingUp style={{ width: '24px', height: '24px', color: 'var(--accent-foreground)' }} />
